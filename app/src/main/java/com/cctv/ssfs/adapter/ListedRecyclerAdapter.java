...
public class ListedRecyclerAdapter extends BaseRecyclerViewAdapter<JSONObject> {
    private Context context;

    public ListedRecyclerAdapter(Context context, @Nullable List<JSONObject> data) {
        super(R.layout.item_listed, data);
